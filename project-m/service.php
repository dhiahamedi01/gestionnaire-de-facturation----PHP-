...
<html lang="ar" dir="rtl">
   ...
   <body>
      <nav>
         ...
         <div class="nav-items">
            <li><a  class="artorito" href="service.php">إنشاء خدمة</a></li>
      ...
      <form enctype="multipart/form-data" action="insert_service.php" class="form" method="POST">
          ...
          <h1>إنشاء خدمة</h1>
              <div class="input-box address">
                ...
                <div class="input-box">
                  ...
                  <input type="text" placeholder="" name="service" required />
                </div>
        
                <div class="column">
                  <div class="input-box">
                    <label>كلفة الخدمة </label>
